...
export const PaymentFeedbackScreenFromSolo = (props) => {

  console.log('PaymentFeedbackScreenFromSolo', props.route.params);
  ...
  const [Amount, setAmount] = useState(rideData.totalfare);
     ...
     <View style={{flexDirection: 'row'}}>
        <View
          ...
          <TouchableOpacity onPress={() => {
              navigationService.navigate('RideProcessScreenFromSolo'); // RideProcessScreen
            }}>
            <Image
      ...
      {/* Drawer content */}
        ...
        <ScrollView>
          ...
          <View
            ...
            <Text style={{color: '#97ADB6'}}>{pickAddress}</Text>
          </View>
          <View
            style={{
              flexDirection: 'column',
            ...
            <Text style={{color: '#97ADB6'}}>{dropAddress}</Text>
          </View>
          <Image
            source={Images.Line}
            style={{marginTop: 20, alignSelf: 'center'}}></Image>
