import {
  ...
  export const YouAreOnDestinationFromDriverScreen = (props) => {

    console.log('data from notfication', props.route.params);

  const rideData =props.route.params.remoteData;
  console.log("YouAreOnDestinationFromDriverScreen", rideData.id);
...
const endRide = async () => {
  ...
  ridesDbRef.update({
    ...
    console.log("Ride End Status Updated");
    navigationService.navigate('PaymentFromDriverSwitchToRideSharingScreen', {'remoteData':rideData}); //toggleModal
