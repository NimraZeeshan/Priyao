import {
  ...
  export const YouAreOnDestinationFromSoloDriverScreen = () => {
  ...
  const animating = () => {
    ...
    mapRef.current.fitToSuppliedMarkers(dropAddress),{ edgePadding:
      {
    ...
    const renderContent = () => (
      <View
        ...
        <View
          ...
          <Text style={{fontSize: 18, fontWeight: 'bold', letterSpacing: 1}}>You have arrived on the destination</Text>
        </View>
{/* 
        <View
          style={{
    ...
    return (
      ...
      <View style={{
        ...
        <PrimaryButton
          ...
          customStyles={styles.PrimaryButton}
          onPress={() => {
            navigationService.navigate('PAymentFromSoloDriverScreen'); //toggleModal
          }}
        />
        </View>
        </View>
