...
import AsyncStorage from '@react-native-async-storage/async-storage';
  ...
  export const PaymentFromDriverSwitchToRideSharingScreen = (props) => {
    console.log('data from notfication', props.route.params);

  const rideData =props.route.params.remoteData;
  console.log("PaymentFromDriverSwitchToRideSharingScreen", rideData.id);
    ...
    const [collectedAmpunt, setCollectedAmpunt] = useState(0);
    const [totalFare, setTotalFare] = useState(parseFloat(rideData.totalfare));
  ...
  <Drawer open={openDrawer} toggleDrawer={toggleDrawer} style={{zIndex: 0}}>
    {/* Drawer content */}
        ...
        <View
          ...
          <Text>{rideData.to_location}</Text>
          {/* <Text style={{marginHorizontal: 60}}>{rideData.from_location.substring(0,15)}</Text> */}
        </View>
        <View
          style={{
            // borderColor: 'black',
          ...
          <Text style={{color: '#97ADB6'}}>{rideData.from_location}</Text>
        ...
        {/* <View
          ...
          <Text style={{color: Colors.HeaderColour, fontSize: 22, fontWeight: 'bold'}}>{totalFare- collectedAmpunt}</Text>
        </View>
        <TextInput
          style={{
            borderColor: 'black',
        ...
        <PrimaryButton
          ...
          onPress={() => {
            navigationService.navigate('ReportFromDriverSwitchToRideSharingScreen'); //RideHistoryScreen
          }}
        />
