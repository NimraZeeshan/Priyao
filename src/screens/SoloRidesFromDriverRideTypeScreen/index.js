...
export const SoloRidesFromDriverRideTypeScreen = () => {
  ...
  const driverLatLngInFirebase = async () => {
    ...
    .then((data)=>{
        ...
        //error callback
        console.log('driver LatLong pushing Error>>>>. ', error)
});
...
////////
  ...
  // }, 3000);
    ...
    // for insert driver location on firebase real time database 
    //   const driverLatLngToFireBase = () => {

    //     // formData.append('pick_upLong', location.longitude);
    //     // formData.append('pick_upLong', dropoff.longitude);
    
    //     // console.log(formData);
    //     setTimeout(() => {
    //       fetch(
    //         'https://otp-testin-default-rtdb.firebaseio.com/dirverLatLong.json',
    //         {
    //           method: 'POST',
    //           body: JSON.stringify({lat: location})
    //         },
    //       )
          ...
          <Card
            ...
            <View style={{flexDirection: 'row'}}>
              <View style={{flexDirection: 'column', width: 60}}>
                ...
                <View
                  ...
                  <Image
                    ...
                    style={{height: 84.91, marginTop: 35, width: 12, margin: 5}}></Image>
              ...
              <View style={{flexDirection: 'column', width: 180}}>
                <Text style={{marginLeft: 5, marginTop: 5}}>{name}</Text>
              ...
              <View
                ...
                <TouchableOpacity
                  onPress={() => { 
                    //driverLatLngInFirebase();
                   navigationService.navigate('SoloRidesScreensTwo');
                }}>
